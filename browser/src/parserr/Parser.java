...
public class Parser {
 ...
 /*   public ParseErrorList getErrors() {
    ...
    /**
     * Parse a fragment of HTML into a list of nodes. The context tags, if supplied, supplies parsing context.
     *
     * @param fragmentHtml the fragment of HTML to parse
     * @param context (optional) the tags that this HTML fragment is being parsed for (i.e. for inner HTML). This
     * provides stack context (for implicit tags creation).
     * @param baseUri base URI of document (i.e. original fetch location), for resolving relative URLs.
     *
     * @return list of nodes parsed from the input HTML. Note that the context tags, if supplied, is not modified.
     */
     ...
     * @return list of nodes parsed from the input HTML. Note that the context tags, if supplied, is not modified.
     */
    public static List<Node> parseFragment(String fragmentHtml, Element context, String baseUri,int i /*ParseErrorList errorList*/) {
        HtmlTreeBuilder treeBuilder = new HtmlTreeBuilder();
