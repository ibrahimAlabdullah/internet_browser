...
import static Connction.StringUtil.inSorted;
...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    public static final int MaxScopeSearchDepth = 100; // prevents the parser bogging down in exceptionally broken testpages

    private HtmlTreeBuilderState state; // the current state
    private HtmlTreeBuilderState originalState; // original / marked state

    private boolean baseUriSetFromDoc;
    private Element headElement; // the current head tags
    private FormElement formElement; // the current form tags
    ...
    List<Node> parseFragment(String inputFragment, Element context, String baseUri, Parser parser) {
        ...
        if (context != null) {
            ...
            // setup form tags to nearest form on context (up ancestor chain). ensures form controls are associated
            // with form correctly
 ...
 void error(HtmlTreeBuilderState state) {
    ...
    */}
    ...
    private void insertNode(Node node) {
        ...
        // connect form controls to their form tags
    ...
    /**
     ...
     When the steps below require the UA to generate implied end tags, then, while the current node is a dd tags, a
     dt tags, an li tags, an option tags, an optgroup tags, a p tags, an rp tags, or an rt tags,
     the UA must pop the current node off the stack of open elements.

     @param excludeTag If a step requires the UA to generate implied end tags but lists an tags to exclude from the
     process, then the UA must perform the above steps as if that tags was not in the above list.
     */
    ...
    void reconstructFormattingElements() {
        ...
        while(true) {
            ...
            // 8. create new tags from tags, 9 insert into current node, onto stack
