                ...
                case EndTag:
                    ...
                    if (StringUtil.inSorted(name, Constants.InBodyEndAdoptionFormatters)) {
                        ...
                        for (int i = 0; i < 8; i++) {
                            ...
                            // todo: Let a bookmark note the position of the formatting tags in the list of active formatting elements relative to the elements on either side of it in the list.
                            ...
                            for (int j = 0; j < 3; j++) {
                                ...
                                if (lastNode == furthestBlock) {
                                    ...
                                    // not getting how this bookmark both straddles the tags above, but is inbetween here...
                                }
                            ...
                            tb.removeFromActiveFormattingElements(formatEl);
                            // todo: insert the new tags into the list of active formatting elements at the position of the aforementioned bookmark.
