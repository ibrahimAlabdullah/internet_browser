...
//import static Connction.NodeTraversor.filter;
...
public abstract class Node implements Cloneable {
    ...
    /**
     * Get all of the tags's attributes.
    ...
    /**
     * Test if this tags has an attribute. <b>Case insensitive</b>
    ...
    /**
     * Remove an attribute from this tags.
     ...
     * returned directly. Otherwise, it is treated as a URL relative to the tags's {@link #baseUri}, and made
     * absolute using that.
     * </p>
     * <p>
     ...
     * Calling {@code tags.unwrap()} on the {@code span} tags will result in the html:
    ...
    public Node filter(NodeFilter nodeFilter) {
      // heree  NodeTraversor.filter(nodeFilter, this);
        return this;
    }

    /**
     Get the outer HTML of this node. For example, on a {@code p} tags, may return {@code <p>Para</p>}.
     @return outer HTML
     @see Element#html()
     @see Element#text()
     */
